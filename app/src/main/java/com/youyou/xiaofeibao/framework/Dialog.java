package com.youyou.xiaofeibao.framework;
...
public class Dialog extends android.app.Dialog {
    ...
    /**
     * 左右按钮模式（该方式设置的按钮左右位置固定，如果可以建议使用{@link #setButton(int, android.content.DialogInterface.OnClickListener, int, android.content.DialogInterface.OnClickListener)}）
     *
    ...
    public void setMiddleView(View v) {
        ...
        if (null == v_content) {
            ...
            RelativeLayout.LayoutParams relap = new RelativeLayout.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT);
