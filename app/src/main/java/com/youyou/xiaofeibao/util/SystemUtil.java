...
public class SystemUtil {
    ...
    public static File getDeviceExternalCacheDir() {
        Context context = ConsumApplication.getInstance().getApplicationContext();
    ...
    public static String getFullVersion() {
        return getVersionName(ConsumApplication.getInstance().getApplicationContext())
                + "." + getVersionCode(ConsumApplication.getInstance().getApplicationContext());
    }
