...
public class GridPasswordView extends LinearLayout implements PasswordView {
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mPadding = (int) ta.getDimension(R.styleable.gridPasswordView_gpvpaddingWidth, Util.dp2px(getContext(), 0));
    ...
    private void inflaterViews(Context context) {
        ...
        while (index < mPasswordLength) {
            ...
            addView(dividerView, dividerParams);//by wy,去掉了中间的线
            ...
            textViewParams.setMargins(mPadding, mPadding, mPadding, mPadding);
    ...
    private GradientDrawable generateBackgroundDrawable() {
        ...
        drawable.setStroke(mLineWidth, mLineColor);//by wy,去掉了外边框
        return drawable;
    }
