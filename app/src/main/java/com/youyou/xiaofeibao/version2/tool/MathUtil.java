...
public class MathUtil {
     ...
     * @return
     */
    public static BigDecimal formatDouble2Bd(Double d) {
        if (d == null) {
            d = 0.0;
        }
        try {
     ...
     * @return
     */
    public static double formatString2Num(String d) {
    ...
    public static double subtractDouble(double first, double second) {
        return subtractDoubleToBigDecimal(first, second).doubleValue();
    }

    public static BigDecimal subtractDoubleToBigDecimal(double first, double second) {
        BigDecimal b1 = formatDouble2Bd(first);
        BigDecimal b2 = formatDouble2Bd(second);
