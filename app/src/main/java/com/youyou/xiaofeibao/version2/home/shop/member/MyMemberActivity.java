...
public class MyMemberActivity extends BaseTitleActivity {
    ...
    private void submitData() {
        ...
        ResponseBuilder<PageRequestObject, MyMemberResponseObjecet> builder = new ResponseBuilder<>(requestObject, Config.MYMEMBER,MyMemberResponseObjecet.class);
