...
public interface IPullToRefresh<T extends View> {
    ...
    /**
     * Returns whether the com.doumee.xiaofeibao.widget has enabled scrolling on the Refreshable View
     * while refreshing.
     *
     * @return true if the com.doumee.xiaofeibao.widget has enabled scrolling while refreshing
     */
